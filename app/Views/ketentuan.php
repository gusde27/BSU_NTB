...
<head>
  ...
  <title>Ketentuan - Beasiswa Stimulan Unggulan</title>
</head>
...
<body class="bg-backBody font-roboto">
  ...
  <div class="dash h-full">
    <header class="lg:px-32 py-10 flex items-center sm:px-20 px-10 ">
      ...
      " id="nav-content">
        ...
        <a href="<?= base_url() ?>/ketentuan" class="mx-3 pb-1 border-b-2 border-darkmain">Ketentuan</a>
    ...
    <section class="flex flex-col justify-center items-center sm:mt-32 mt-16 pb-36">
      <div class="logo border-4 rounded-full p-4 w-36 h-36 flex items-center justify-center border-darkmain mb-10"><i class="fas fa-cog text-darkmain text-7xl"></i></div>
      <h1 class="text-darkmain font-black xl:text-6xl lg:text-5xl sm:text-4xl text-2xl text-center">KETENTUAN</h1>
  ...
  <section class="bg-darkmain h-full" id="persyaratan">
    <div class="lg:pt-28 pt-16 flex justify-center items-center pb-16">
      <i class="fas fa-cog text-backBody mx-2 lg:text-8xl text-6xl "></i>
      <h1 class="text-backBody mx-2 text-3xl md:text-5xl font-medium"> Ketentuan</h1>
    </div>
    <div class="flex justify-center flex-col items-center pb-24">
      <div class="
      bg-lightmain flex justify-center lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        <div class="pr-5 border-r-2 border-darkmain mr-5 text-backBody font-bold text-6xl">1</div>
        <p class="text-backBody leading-5">Setiap calon penerima beasiswa yang lolos seleksi, wajib mengisi formulir kesediaan mengikuti seleksi berikutnya</p>
      </div>
      <div class="
      ...
      ">
        ...
        <p class="text-backBody leading-5">Bagi penerima beasiswa yang membutuhkan biaya penelitian, wajib menyerahkan lapran keuangan paling lambat 3 (tiga) bulan setelah dilakukan pencairan dana</p>
      </div>
      <div class="
      bg-lightmain flex justify-start lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        ...
        <p class="text-backBody leading-5">Bagi penerima beasiswa, penerimaan dana akan dilakukan sekali setiap tahun</p>
      </div>
      <div class="
      bg-lightmain flex justify-start lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        ...
        <p class="text-backBody leading-5">Periode pendaftaran dan alur pendaftaran paling sedikit selama 2 (dua) bulan</p>
      </div>
    </div>
  </section>
