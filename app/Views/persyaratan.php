...
<head>
  ...
  <title>Persyaratan - Beasiswa NTB Dalam Negeri</title>
</head>
...
<body class="bg-backBody font-roboto">
  ...
  <div class="dash h-full">
    <header class="lg:px-32 py-10 flex items-center sm:px-20 px-10 ">
      ...
      " id="nav-content">
        ...
        <a href="<?= base_url() ?>/persyaratan" class="mx-3 pb-1 border-b-2 border-darkmain">Persyaratan</a>
        <a href="<?= base_url() ?>/alur-seleksi" class="mx-3 pb-1 border-b-2 border-transparent hover:border-b-2  hover:border-darkmain">Alur Seleksi</a>
    ...
    <section class="flex flex-col justify-center items-center sm:mt-32 mt-16 pb-36">
      <div class="logo border-4 rounded-full p-4 w-36 h-36 flex items-center justify-center border-darkmain mb-10"><i class="fas fa-list-alt text-darkmain text-7xl"></i></div>
      <h1 class="text-darkmain font-black xl:text-6xl lg:text-5xl sm:text-4xl text-2xl text-center">PERSYARATAN</h1>
      ...
      <p class="text-lightmain xl:w-5/12 text-center py-5 px-2 font-medium md:text-lg text-sm">
        Berikut merupakan persyaratan yang harus diikuti oleh calon penerima Beasiswa Stimulan Unggulan sebelum mendaftar
      </p>
  ...
  <section class="bg-darkmain h-full" id="persyaratan">
    <div class="lg:pt-28 pt-16 flex justify-center items-center pb-16">
      <i class="fas fa-newspaper text-backBody mx-2 lg:text-8xl text-6xl "></i>
      <h1 class="text-backBody mx-2 text-3xl md:text-5xl font-medium"> Persyaratan</h1>
    </div>
    <div class="flex justify-center flex-col items-center pb-24">
      <div class="
      bg-lightmain flex justify-start lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        <div class="pr-5 border-r-2 border-darkmain mr-5 text-backBody font-bold text-6xl">1</div>
        <p class="text-backBody leading-5">Mahasiswa Asal NTB yang sedang menempuh jenjang pendidikan S1,S2 dan S3 pada PTS/PTN di dalam negeri pada Program Studi unggulan yang telah ditetapkan</p>
      </div>
      <div class="
      bg-lightmain flex justify-start lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        <div class="pr-5 border-r-2 border-darkmain mr-5 text-backBody font-bold text-6xl">2</div>
        <p class="text-backBody leading-5">Minimum IPK 3.0 bagi lulusan baru S1 dan S2</p>
      </div>
      <div class="
      bg-lightmain flex justify-start lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        <div class="pr-5 border-r-2 border-darkmain mr-5 text-backBody font-bold text-6xl">3</div>
        <p class="text-backBody leading-5">Minimum IPK 3.0 selama 2 (dua) Semester berturut-turut bagi mahasiswa <i>On Going</i> </p>
      </div>
      <div class="
      bg-lightmain flex justify-start lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        <div class="pr-5 border-r-2 border-darkmain mr-5 text-backBody font-bold text-6xl">4</div>
        <p class="text-backBody leading-5">Sisa durasi pendidikan pada saat mendaftar adalah 2 (dua) semester atau maksimal 3 (tiga) semester</p>
      </div>
      <div class="
      bg-lightmain flex justify-start lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        <div class="pr-5 border-r-2 border-darkmain mr-5 text-backBody font-bold text-6xl">5</div>
        <p class="text-backBody leading-5">Terdapat tambahan persyaratan pada saat pendaftaran tergantung pada kriteria dan komponen beasiswa yang ditawarkan</p>
      </div>
      <div class="
      bg-lightmain flex justify-start lg:items-center px-5 py-3 rounded-md shadow-md xl:w-5/12 lg:w-6/12 md:w-7/12 sm:w-8/12 transform transition-transform hover:scale-105 my-4
        items-start w-10/12
      ">
        <div class="pr-5 border-r-2 border-darkmain mr-5 text-backBody font-bold text-6xl">6</div>
        <p class="text-backBody leading-5">Tidak sedang menerima bantuan pendidikan atau beasiswa sejenis untuk komponen pendidikan yang sama dari sumber lain</p>
      </div>
    </div>
  </section>
